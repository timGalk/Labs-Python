...
# Note. There are a few fragments of code use GenAI, all generated expression were rechecked manually
class TestWeekday(unittest.TestCase):
    # The tests were  generated by Claude AI for the promt generate tests for the code
...
class TestRandomWalk(unittest.TestCase):
    def test_valid_steps(self):
        ...
        # The tests were  generated by Claude AI for the prompt: generate tests for provided code
...
class TestDNAComplement(unittest.TestCase):
    ...
    def test_invalid_inputs(self):
        ...
        with self.assertRaises(ValueError): # Empty string
            dna_complement("")
        with self.assertRaises(ValueError): # String consists of one space
            dna_complement(" ")
